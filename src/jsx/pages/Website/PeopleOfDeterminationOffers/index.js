...
import AddPeopleOfDeterminationOffersModal from "./AddPeopleOfDeterminationOffersModal";
import CardItem from "./CardItem";
import './style.scss'
import PeopleOfDeterminationOffersService from "../../../../services/PeopleOfDeterminationOffersService";

const PeopleOfDeterminationOffers = () => {
  ...
  return (
    <Fragment>
      <Card className="mb-3">
        <Card.Body className="d-flex justify-content-between p-3 align-items-center">
          ...
          {isExist('website') && <Button variant="primary" className='me-2 h-75' onClick={()=> { 
              ...
              {Translate[lang]?.add} {Translate[lang]?.peopleOfDeterminationOffers}
          </Button>}
        </Card.Body >
      </Card>
        ...
        <Col lg={12}>
          <Card>
            ...
            {loading && <div style={{height: '300px'}}>
              ...
              <Pagination
                  setData={setData}
                  service={peopleOfDeterminationOffersService}
      ...
      {addModal && 
        <AddPeopleOfDeterminationOffersModal
          item={item} 
          addModal={addModal} 
          setShouldUpdate={setShouldUpdate}
...
export default PeopleOfDeterminationOffers;
